/*
 * PROVENANCE: vendored from https://github.com/TestSubjector/BattleCode2022
 *   (src/AFinalsBot). Team "Do Lonely Laboratories Dream of Golden Anomalies?" --
 *   Battlecode 2022 finalist (Symbotic "Most Adaptive Strategy" prize). No explicit
 *   repo license; the scaffold ships AGPL-3.0. Included as a publicly-posted
 *   reference bot. Only modification: package rename AFinalsBot -> sample_afinals.
 */
package sample_afinals;
